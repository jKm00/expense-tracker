  ...
  return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <Card className="p-3 text-center">
        <p className="text-[11px] font-medium text-gray-500">Income</p>
      ...
      <Card className="p-3 text-center">
        <p className="text-[11px] font-medium text-gray-500">Variable</p>
      ...
      <Card className="p-3 text-center">
        <p className="text-[11px] font-medium text-gray-500">Fixed</p>
      ...
      <Card className="col-span-3 p-3 text-center">
