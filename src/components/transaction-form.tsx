      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="0.00"
            className="h-16 w-full rounded-xl border-2 border-gray-200 bg-white pl-10 pr-4 text-2xl font-medium transition-colors placeholder:text-gray-300 focus:border-gray-900 focus:outline-none"
            autoFocus
          />
        </div>
      </div>
