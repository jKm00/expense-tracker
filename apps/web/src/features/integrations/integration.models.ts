...
export type IntegrationEvent = InferSelectModel<typeof integrationEvents>;
export type NewIntegrationEvent = InferInsertModel<typeof integrationEvents>;

export type IntegrationRequestLog = InferSelectModel<typeof integrationRequestLogs>;
