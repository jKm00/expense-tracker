...
} from "@/features/shopping/shared/shopping.dtos";
...
import { PRODUCT_QUERY_KEY } from "@/features/products/client/products.queries";
import { TRANSACTION_QUERY_KEY } from "@/features/transactions/client/transactions.queries";
