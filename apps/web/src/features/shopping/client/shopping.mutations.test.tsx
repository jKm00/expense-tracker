...
vi.mock("@/features/shopping/server/shopping.controller", () => ({
  shoppingController: {
...
vi.mock("@/features/products/client/products.queries", () => ({
  PRODUCT_QUERY_KEY: "products",
}));

vi.mock("@/features/transactions/client/transactions.queries", () => ({
  TRANSACTION_QUERY_KEY: "transactions",
}));

vi.mock("@/features/auth/server/auth.utils", () => ({
  authenticated: {},
  getSession: vi.fn(),
}));
