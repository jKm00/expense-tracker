  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-end justify-between">
        <PageHeader>
          <PageHeaderTitle>Analytics (v2)</PageHeaderTitle>
          <PageHeaderDescription>
            Deep dive into your economics, spending trends, and category breakdowns.
          </PageHeaderDescription>
        </PageHeader>
        <div className="flex items-center gap-2 pb-4">
          <MonthSelect from="/_app/dashboard/v2/analytics" to="/dashboard/v2/analytics" />
        </div>
      </div>
